...
export const NotificationBell = () => {
  ...
  return (
    <div ref={panelRef} className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-3 w-[360px] overflow-hidden rounded-2xl border border-white/10 bg-[#101318] shadow-2xl">
            ...
            {isLoadingNotifications ? (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-2 text-xs text-white/40">{formatRelativeTime(notification.createdAt)}</p>
                    </div>
                    {!notification.isRead && (
              ...
              <div className="px-4 py-8 text-center">
                ...
                <p className="mt-1 text-xs text-white/45">
                  New task activity will show up here.
                </p>
              </div>
            )}
          </div>
